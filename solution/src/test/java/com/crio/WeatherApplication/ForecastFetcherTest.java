...
class ForecastFetcherTest {
  ...
  public void getWoeIdsFromJson2CitiesTest() throws IOException {
    ForecastFetcher forecastFetcher = new ForecastFetcher();
    String inputJson = "[{\"title\":\"Brisbane\",\"location_type\":\"City\",\"woeid\":1100661,\"latt_long\":\"-27.468880,153.022827\"},"
        + "{\"title\":\"Bangkok\",\"location_type\":\"City\",\"woeid\":1225448,\"latt_long\":\"13.753330,100.504822\"}]\n";
  ...
  public void incorrectJsonShouldThrowException() {
    ...
    assertThrows(IOException.class, () -> forecastFetcher
